...
Based on mmseg, timm2 and DeiT code bases
...
class XCiT(nn.Module):
    """
    Based on timm2 and DeiT code bases
    https://github.com/rwightman/pytorch-image-models/tree/master/timm
    https://github.com/facebookresearch/deit/
    """
    ...
    def forward_features(self, x):
        ...
        pos_encoding = self.pos_embeder(B, Hp, Wp).reshape(B, -1, x.shape[1]).permute(0, 2, 1).contiguous()
